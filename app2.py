...
images = [
    ...
    {"name": "Nancy Ajram", "image_path": "images/Nancy Ajram.jpg"},
...
# اسم الملف الذي سيحتوي على سجل الحضور
...
# Initialize global variables for accuracy calculation
total_faces = 0
...
def get_recognized_names(result_image, temp_path):
    ...
    for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
        ...
        if True in matches:
            total_faces += 1  # Increase total face count
